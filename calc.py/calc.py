...
b_3.place(x=177, y=0)
b_4 = Button(Frame_quadros, text="7", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: entering_valures(7))
b_4.place(x=0, y=29)
b_5 = Button(Frame_quadros, text="8", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: entering_valures(8))
b_5.place(x=59, y=29)
b_6 = Button(Frame_quadros, text="9", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: entering_valures(9))
...
b_8 = Button(Frame_quadros, text="4", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: entering_valures(4))
b_8.place(x=0, y=58)
b_9 = Button(Frame_quadros, text="5", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: entering_valures(5))
b_9.place(x=59, y=58)
b_10 = Button(Frame_quadros, text="6", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: entering_valures(6))
...
b_12= Button(Frame_quadros, text="1", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: entering_valures(1))
b_12.place(x=0, y=87)
b_13= Button(Frame_quadros, text="2", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: entering_valures(3))
b_13.place(x=59, y=87)
b_14= Button(Frame_quadros, text="3", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: entering_valures(3))
...
b_16= Button(Frame_quadros, text="0", width=14, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: entering_valures(0))
...
b_17= Button(Frame_quadros, text="=", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED,overrelief=RIDGE,command=lambda: calculate('='))
b_17.place(x=177, y=116)
